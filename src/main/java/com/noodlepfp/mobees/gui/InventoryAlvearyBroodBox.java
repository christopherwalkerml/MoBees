...
public class InventoryAlvearyBroodBox extends InventoryAdapterTile<TileAlvearyBroodBox> implements ISlotPickupWatcher {
    public static final int SLOT_MUTAGEN = 0;

    public InventoryAlvearyBroodBox(TileAlvearyBroodBox alvearyBroodBox) {
        super(alvearyBroodBox, 1, "Items", 64);
    }
