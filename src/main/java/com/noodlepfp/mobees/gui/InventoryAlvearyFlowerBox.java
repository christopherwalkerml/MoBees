...
public class InventoryAlvearyFlowerBox extends InventoryAdapterTile<TileAlvearyFlowerBox> implements ISlotPickupWatcher {
    public static final int SLOT_MUTAGEN = 0;

    public InventoryAlvearyFlowerBox(TileAlvearyFlowerBox alvearyFlowerBox) {
        super(alvearyFlowerBox, 1, "Items", 64);
    }
