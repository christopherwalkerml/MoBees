...
public class MoreBeesApicultureItems {
    ...
    public static final FeatureItem<MoreBeesItemHiveFrame> FRAME_PRESERVATION = REGISTRY.item(() -> new MoreBeesItemHiveFrame(256,2.0f, 0.8f, 0.8f, 1, 1,false, false, false), "frame_preservation");
}
