...
public class MoreBeesTilePowerable extends MoreBeesTileActivatable {
    ...
    public MoreBeesTilePowerable(MoreBeesBlockAlvearyType blockType, BlockPos pos, BlockState state, String actionVerb, int ticksPerOp, int fePerOp) {
